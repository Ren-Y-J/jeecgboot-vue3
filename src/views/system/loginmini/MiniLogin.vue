<template>
  <div :class="prefixCls" class="login-background-img">
    <!-- <AppLocalePicker class="absolute top-4 right-4 enter-x xl:text-gray-600" :showText="false" 切换中文和英文/> -->
    <!-- <AppDarkModeToggle class="absolute top-3 right-7 enter-x" /> 显示黑天白夜 -->
