    ...
    <div>
      ...
      <a-modal v-model:visible="visible" title="Basic Modal" @ok="handleOk">
        ...
        <a-form ref='lineRef' name="basic" :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }" autocomplete="off"
          ...
          <a-form-item :rules="fromaclinfoRules.lineName" label="线路名称" name="lineName" style='margin-top: 26px'>
            <a-input placeholder="请输入线路名称" />
          </a-form-item>
...
<script name='lines' setup>
import { ref, defineComponent, reactive } from 'vue'
// import { list, gethostsAll, delline, getaclIdAll } from './line'
import { list, gethostsAll, delline, getaclIdAll } from "./line";
