...
<script setup>
	import { GetList, DelList, GetLine,AddList,EditList,BackLine  } from './deploy.ts';
	...
	const { id, pageNum, pageSize, initdata, total, visible, formState, groupData,  addRecord,formState_1,edit_visible,formState_edit } = toRefs(data);
	const columns = [
		{
			title: '正向域名',
			dataIndex: 'name',
